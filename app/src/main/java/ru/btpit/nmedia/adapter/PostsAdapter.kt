...
class PostViewHolder(
    ...
    fun bind(post: Post) {
        binding.apply {
            ...
            shareCount.text = getFormatedNumber(post.shares.toLong())
            ...
            shareCount.text = post.shares.toString()
            when {
                post.shares < 1000 -> shareCount.text = post.shares.toString()
                post.shares in 1000..999999 -> shareCount.text = "${post.shares / 1000}K"
